...
class RegistroViewModel : ViewModel(), IRegistroViewModel {
    ...
    override val _opcionesSexo = MutableLiveData(listOf(R.string.hombre, R.string.mujer))
    val opcionesSexo = _opcionesSexo

    override val _opcionEscogida = MutableLiveData<Int>()
    val opcionEscogida = _opcionEscogida

    override val _textoNombre = MutableLiveData("")
    val textoNombre: LiveData<String> = _textoNombre

    override val _textoContrasena = MutableLiveData("")
    val contrasena: LiveData<String> = _textoContrasena

    override val _textoContrasenaConfirmacion = MutableLiveData("")
    val contrasenaConfirmacion: LiveData<String> = _textoContrasenaConfirmacion

    override val _mensajeToast = MutableLiveData<Int>()
    val mensajeToast: LiveData<Int> = _mensajeToast

    override val _toastMostrado = MutableLiveData<Boolean>()
    val toastMostrado: LiveData<Boolean> = _toastMostrado

    override val _textoCorreo = MutableLiveData("")
    val correo = _textoCorreo

    override val _mostrarContrasena = MutableLiveData(true)
    val mostrarContrasena = _mostrarContrasena

    override val _checboxTerminos = MutableLiveData(false)
    val checboxTerminos = _checboxTerminos

    override val _textoFechaNacimiento = MutableLiveData<LocalDate>()
